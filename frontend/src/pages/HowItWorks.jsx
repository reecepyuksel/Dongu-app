...
import { PackageOpen, Sparkles, Handshake, ArrowRight, Star, Trophy, Award, Gem } from 'lucide-react';
...
const HowItWorks = () => {
    ...
    const ranks = [
        { name: 'Yeni Paylaşımcı', range: '0 – 250 Puan', emoji: '🥉', bg: 'bg-amber-50', border: 'border-amber-200', text: 'text-amber-800' },
        { name: 'İyilik Yolcusu', range: '251 – 750 Puan', emoji: '🥈', bg: 'bg-slate-50', border: 'border-slate-200', text: 'text-slate-700' },
        { name: 'İyilik Elçisi', range: '751 – 2000 Puan', emoji: '🥇', bg: 'bg-yellow-50', border: 'border-yellow-200', text: 'text-yellow-800' },
        { name: 'Döngü Ustası', range: '2000+ Puan', emoji: '💎', bg: 'bg-emerald-50', border: 'border-emerald-200', text: 'text-emerald-800' },
    ];
        ...
        <div className="min-h-screen bg-slate-50 py-20 px-6">
            <div className="max-w-5xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    >
                        Eşyalarını paylaşmak veya yeni bir eşya edinmek Döngü ile çok basit! Sadece 3 adımda iyiliği çevremize yayalım.
                    </motion.p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                    ...
                    >
                        ...
                        <div className="bg-blue-100 text-blue-700 font-bold px-3 py-1 rounded-full text-xs mb-4">Adım 1</div>
                        <h3 className="text-2xl font-bold text-slate-800 mb-3 font-[Outfit]">İlan Aç veya Katıl</h3>
                        <p className="text-slate-600 text-sm">
                            Kullanmadığın ama başkasının işine yarayacak eşyalarını sisteme yükle. Ya da Vitrin'de ilgini çeken eşyaların döngüsüne "Döngüye Katıl" butonu ile dahil ol.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="bg-emerald-100 text-emerald-700 font-bold px-3 py-1 rounded-full text-xs mb-4">Adım 2</div>
                        <h3 className="text-2xl font-bold text-slate-800 mb-3 font-[Outfit]">Eşleşme</h3>
                        <p className="text-slate-600 text-sm">
                            Sistemimiz, katılım süresi dolduğunda otomatik çekilişle veya tamamen bağışçının insiyatifiyle eşyayı alacak şanslı kişiyi belirler ve her iki tarafa anında bildirim gönderir.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="bg-amber-100 text-amber-700 font-bold px-3 py-1 rounded-full text-xs mb-4">Adım 3</div>
                        <h3 className="text-2xl font-bold text-slate-800 mb-3 font-[Outfit]">Döngüyü Tamamla</h3>
                        <p className="text-slate-600 text-sm">
                            Kargo ile veya belirlenen noktada elden teslimatı gerçekleştir. Eşyayı alan kişi teslimatı sistem üzerinden onaylayınca her iki taraf da değerli "İyilik Puanı" kazanır!
                        </p>
                    </motion.div>
                </div>
                ...
                >
                    <div className="text-center mb-12">
                        ...
                        <p className="text-slate-500 text-lg max-w-xl mx-auto">Vitrin'deki eşyaları takas etmek veya kendi eşyanızla yeni bir teklif başlatmak çok kolay.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative mt-10">
                        ...
                        >
                            ...
                            <div className="bg-emerald-200 text-emerald-800 font-bold px-3 py-1 rounded-full text-xs mb-4">Takas Adım 1</div>
                            <h3 className="text-xl font-bold text-emerald-900 mb-3 font-[Outfit]">Teklif Ver</h3>
                            <p className="text-emerald-700/80 text-sm font-medium">
                                "Takaslık" rozeti olan eşyalara kendi eşyanı sun. Vitrininde aktif ilan yoksa metin veya fotoğrafla desteklediğin bir teklif de yapabilirsin.
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="bg-amber-200 text-amber-800 font-bold px-3 py-1 rounded-full text-xs mb-4">Takas Adım 2</div>
                            <h3 className="text-xl font-bold text-amber-900 mb-3 font-[Outfit]">Onay Bekle</h3>
                            <p className="text-amber-800/80 text-sm font-medium">
                                Gönderdiğin teklif mesaj kutusuna düşer. Karşı taraf teklifi değerlendirir; dilerse pazarlık yapabilir, reddedebilir veya onaylayabilir.
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="bg-blue-200 text-blue-800 font-bold px-3 py-1 rounded-full text-xs mb-4">Takas Adım 3</div>
                            <h3 className="text-xl font-bold text-blue-900 mb-3 font-[Outfit]">Güvenle Takas Et</h3>
                            <p className="text-blue-800/80 text-sm font-medium">
                                Anlaşma sağlandığında eşyalarınızı belirlediğiniz yöntemle güvenle takas edin. Tamamlanan her takasta +100 iyilik puanı kazanılır!
                            </p>
                        </motion.div>
                    </div>
                </motion.div>
                ...
                >
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-black text-slate-800 font-[Outfit] mb-3">İyilik Rehberi</h2>
                        <p className="text-slate-500 text-lg max-w-xl mx-auto">Paylaştıkça puan kazan, seviye atla ve topluluğun yıldızı ol!</p>
                    </div>
                        ...
                        <div className="divide-y divide-slate-50">
                            {pointsTable.map((item, idx) => (
                                ...
                                >
                                    ...
                                    <span className="text-emerald-600 font-extrabold text-lg font-[Outfit]">{item.points}</span>
                                </motion.div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                        {ranks.map((rank, idx) => (
                            ...
                            >
                                <div className="text-5xl mb-4 group-hover:scale-110 transition-transform">{rank.emoji}</div>
                                <h4 className={`text-lg font-extrabold ${rank.text} font-[Outfit] mb-1`}>{rank.name}</h4>
                                <p className="text-sm text-slate-500 font-semibold">{rank.range}</p>
                            </motion.div>
                        ))}
                    </div>
                </motion.div>
